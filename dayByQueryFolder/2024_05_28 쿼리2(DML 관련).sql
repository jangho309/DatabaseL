...
INSERT INTO EMP(SAL) VALUES ('ㅁㅁㅁㅁ');
...
UPDATE DEPT_COPY1 
   SET (DNO, DNAME, LOC, DIRECTOR) = (SELECT DNO
                                           , DNAME
                                           , LOC
                                           , DIRECTOR
                                        FROM DEPT
...
DELETE FROM STUDENT_COPY1
 WHERE SNO IN (SELECT SCP1.SNO
                 FROM STUDENT_COPY1 SCP1
                 JOIN SCORE SC
                   ON SCP1.SNO = SC.SNO
                GROUP BY SCP1.SNO
...
;
-- 데이터 다시 채우기
MERGE INTO STUDENT_COPY1 SCP1
USING STUDENT ST
   ON (SCP1.SNO = ST.SNO)
WHEN MATCHED THEN
    UPDATE SET SCP1.SNAME = ST.SNAME
             , SCP1.SEX = ST.SEX
             , SCP1.SYEAR = ST.SYEAR
             , SCP1.MAJOR = ST.MAJOR
             , SCP1.AVR = ST.AVR
WHEN NOT MATCHED THEN
    INSERT (SCP1.SNO, SCP1.SNAME, SCP1.SEX, SCP1.SYEAR, SCP1.MAJOR, SCP1.AVR)
    VALUES (ST.SNO, ST.SNAME, ST.SEX, ST.SYEAR, ST.MAJOR, ST.AVR)
;
